<aside class="px-2 py-6 sm:px-6 lg:py-0 lg:px-0 lg:col-span-3">
	<nav class="space-y-1">
		<a
			...
			<span class="truncate ml-2"> General Information </span>
		</a>
		<a
			...
			<span class="truncate ml-2"> Social Links </span>
		</a>
		<a
			...
			<span class="truncate ml-2"> Branding </span>
		</a>
		<a
			...
			<span class="truncate ml-2"> Issuer Portal </span>
		</a>
		<a
			...
			<span class="truncate ml-2"> Billing Information </span>
		</a>

		<a
			href="/quick-certify/settings/account/skill"
			class="sidebar-nav">
			<!-- Heroicon name: outline/user-circle -->
			<svg
				xmlns="http://www.w3.org/2000/svg"
			...
			<span class="truncate ml-2"> Skills </span>
		</a>
	</nav>
</aside>
