<script>
	import Header from '$quick-kb/common/navbar/admin.svelte';
	import Sidebar from '$quick-kb/common/navbar/sidebar.svelte';
</script>
				...
				<div>
					...
					<div class="flex flex-row items-start">
						<textarea
							type="text"
							id="footer"
							class="bg-gray-50 mt-2 me-2 border border-gray-300 h-32 text-gray-900 text-sm rounded focus:ring-blue-500 focus:border-blue-500 w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
