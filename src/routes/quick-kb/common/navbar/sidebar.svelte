<aside class="px-2 py-6 sm:px-6 lg:py-0 lg:px-0 lg:col-span-3">
	<nav class="space-y-1">
		<a
			href="/quick-kb/adminland/settings"
			class="text-gray-900 hover:bg-gray-200 rounded px-3 py-2 flex items-center text-sm font-medium">
		...
		<a
			href="/quick-kb/adminland/password"
