	...
	<div class="max-w-3xl px-4 mb-16 mx-auto lg:px-6 sm:py-8 lg:py-8">
		<div
			...
			<div class="mt-2 mb-4 text-sm">
				This workspace has been archived by Aashish Dhawan on June 12, 2024. This is no longer
		...
		<div
			class="max-w-3xl p-5 mx-auto mt-4 space-y-5 border border-gray-100 rounded-md bg-gray-50 dark:bg-gray-800 dark:border-gray-700 shadow-sm">
