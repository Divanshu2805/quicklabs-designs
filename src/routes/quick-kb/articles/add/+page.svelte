<main>
	<div class="bg-white relative z-0 flex-1 overflow-x-scroll focus:outline-none h-screen">
		...
		<article
			class="flex justify-center mx-auto w-full max-w-7xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
			<img
				src="/SCR-20250217-teef.png"
				alt="Cherry-Pick Command and its usage"
				class="max-w-7xl object-cover" />
		</article>
	</div>
</main>
