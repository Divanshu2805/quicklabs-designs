	...
	<div class="flex flex-col justify-between px-4 mx-auto max-w-screen-xl">
		<div class="justify-center mx-auto">
			<div
				...
				class="p-4 mb-4 max-w-2xl text-red-800 border border-red-300 rounded-md bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800"
				role="alert">
				...
				<div class="mt-2 mb-4 text-sm">
					This article has been archived by Aashish Dhawan on June 12, 2024. This is no longer
					visible to users but can be restored at any time.
				</div>
				<div class="flex">
					<button
						type="button"
		...
		<!-- Breadcrumb -->
		<nav class="flex grow-0 justify-center px-5 py-3 text-gray-700" aria-label="Breadcrumb">
		...
		<article
			...
			<p>
				You can check out the <a href="https://flowbite.com/docs/getting-started/quickstart/"
					>quickstart guide</a> to explore the elements by including the CDN files into your project.
				But if you want to build a project with Flowbite I recommend you to follow the build tools steps
