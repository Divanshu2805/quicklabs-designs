			...
			<div class="p-6 space-y-4 md:space-y-6 sm:p-8">
				...
				<form class="space-y-4 md:space-y-6" action="#">
					...
					<div class="flex items-center justify-between">
						...
						<a href="/quick-test/forgot-password" class="link">Forgot password?</a>
					</div>
					<a href="/quick-test/changelog">
					...
					<p
						...
						Don’t have an account yet? <a href="/quick-test/signup" class="link ml-2">Sign up</a>
					</p>
				</form>
			</div>
		</div>
