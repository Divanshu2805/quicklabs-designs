<script>
	...
	import ArchiveNavBar from '$quick-test/common/navbar/archivesidebar.svelte';
</script>
	...
	<div class="lg:grid lg:grid-cols-12 lg:gap-x-5">
		...
		<main class="max-w-xl px-4 pb-12 lg:col-span-8">
			<div class="overflow-hidden bg-white">
				<div class="pb-4 ml-4">
					<div>
						<h1 class="form-title">Archived Projects</h1>
						<p class="form-subtitle">Following projects have been archvied.</p>
					</div>
				</div>
												...
												<div>
													...
													<div class="flex-1 w-full mt-2">
														<div class="flex items-center text-sm text-gray-500">
															...
															<p>Archived on July 23, 2024 by Aashish Dhawan</p>
														</div>
													</div>
												</div>
											</div>
