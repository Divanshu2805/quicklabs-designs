...
function _page($$renderer) {
  ...
  $$renderer.push(`<!----></aside> <main class="max-w-xl pb-12 px-4 lg:col-span-6 space-y-4"><div><h1 class="form-title">Payments</h1> <p class="form-subtitle">Manage your payment methods</p></div> <div><p class="text-gray-700 dark:text-gray-400 text-sm">You have an active subscription for our plan of $49/month.</p> <button class="btn-primary mt-2">Manage Subscription</button></div></main></div></main>`);
}
export {
  _page as default
};
